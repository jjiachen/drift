...
plot = GMapPlot(plot_width=1100, plot_height=600,x_range=xdr, y_range=ydr, map_options=map_options,title=None,min_border=0,toolbar_location=None,outline_line_color=None)
"""
...
plot.add_tools(PanTool(), WheelZoomTool(),HoverTool(), ResetTool(),CrosshairTool())
...
"""       
 <section>
                <img width="10%" style="text-align:left; float:left; width:7%; margin-left:2%; margin-top:1%" class="social-icon" src="noaalogo.jpg"><a> </a></p>
                <h2 style="text-align:center;font-size:25px; height:40px;">Educational Passages Miniboat Enthusiast</h2>
                <div style="font-size:15px;">
                <ul>
                <li><a href="file:///home/zdong/xiaoxu/drift/Drift_people.html">Drift_people</a><li>
                <a href="https://docs.google.com/spreadsheets/d/1dLaEVaetME7IDXVxulebM6mtZMBX_HZTztFFgzSOs7Q/edit?ts=5a33f105#gid=0">EP_people_MASTER_cs_copy</a></li>
                </ul>
                </div>
        </section>     
"""
