...
from bokeh.models import (GMapPlot, GMapOptions, ColumnDataSource, Circle,Range1d, DataRange1d, PanTool, WheelZoomTool, HoverTool, ResetTool,CrosshairTool)
...
#GOOGLE_API_KEY= "AIzaSyCv-fr0_kxOGE0Qe0bygKVvG064rV-Hrps"
xdr = Range1d(0,1000)
ydr = Range1d(0,1000)
map_options = GMapOptions(lat=37.9643, lng=-91.8318, map_type="roadmap", zoom=4)# satellite, roadmap, terrain or hybrid
plot = GMapPlot(plot_width=1100,plot_height=600,x_range=xdr, y_range=ydr,min_border=0, map_options=map_options
